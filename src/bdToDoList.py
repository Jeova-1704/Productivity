...
class ToDOStatus:
    ...
    def __init__(self):
        self.conn = sqlite3.connect('../src/todolistStatus.db')
    ...
    def registroDeTarefas(self, ListaTarefas):
        self.cursor.execute('INSERT INTO todolistStatus(tarefa, status, descricao, nivel_Importancia) VALUES (?, ?, ?, ?)', ListaTarefas)

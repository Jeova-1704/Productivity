...
frase_foco = Label(inf_tempo, text="# Bora focar!", fg=COR_BRANCA, font="SpaceMono 20")
frase_foco.pack()

label0 = Label(inf_tempo, fg=COR_BRANCA, font="SpaceMono 20")
# icon
imagem_pomodoro = PhotoImage(file="view/assets/Ellipse 4.png")
...
button_icon = Button(inf_tempo, image=imagem_pomodoro, command=...)
button_icon.pack()
...
frase_pausa = Label(tabela_pausa, text="Partiu dar uma pausa!", bg=COR_LARANJA_CLARO, fg=COR_BRANCA, font="SpaceMono 20")
frase_pausa.pack()

label1 = Label(tabela_pausa, text="Intervalos", fg=COR_BRANCA, font="SpaceMono 35")
label1.pack()
'''importar a imagem do circulo branco para botar no fundo de uma váriavel t que contabilizará o total de intervalos'''

label2 = Label(tabela_pausa, text="Pausa curta", fg=COR_BRANCA, font="SpaceMono 30", bd=4, relief="sunken")
label2.pack()
label3 = Label(tabela_pausa, text="Pausa média", fg=COR_BRANCA, font="SpaceMono 30", bd=4, relief="sunken")
label3.pack()
label4 = Label(tabela_pausa, text="Pausa longa", fg=COR_BRANCA, font="SpaceMono 30", bd=4, relief="sunken")
label4.pack()

...
class Funcoes:
    ...
    def __init__(self, frame_calendario, cal, frame_tabela):
    ...
    def selecionar_data(self):
        ...
        event = simpledialog.askstring(
            "Adicionar Evento", f"Digite o evento para {selected_date}:", parent=self.frame_calendario
        )
        if event:
    ...
    def mostrar_eventos_para_data(self, data):
        ...
        for evento_id, evento_data, evento_descricao in dados:
            if evento_data == data:
                ...
                remover_button = Button(evento_frame, text="Remover",

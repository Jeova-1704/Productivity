...
from view import ToDoList, Calendario, Team, BlocoDeNotas, pomodoro , dashboard
...
def renderizer_main():
    ...
    height = 700
    janela = Tk()
    janela.iconbitmap('../view/assets/IconProductivity.ico')
    ...
    label = Button(frame_top, text=Botao_Codigo, fg=colors.COR_BRANCA, bg=colors.COR_CINZA_ESCURO,
                   font=('monospace', 32), relief=FLAT,command=lambda: renderizar_dashboard(janela))
    ...
    img_logo = PhotoImage(file='assets/LogoProductivity.png')
    ...
    img_ToDoList = PhotoImage(file='assets/EllipseToDoList.png')
    ...
    img_Anotacoes = PhotoImage(file='assets/EllipseBlocoDeNotas.png')
    ...
    img_Calendario = PhotoImage(file='assets/EllipseCalendario.png')
    ...
    img_Pomodoro = PhotoImage(file='assets/EllipsePomodoro.png')

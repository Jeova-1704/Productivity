...
msg = StringVar()
msg.set("X")
pC_botao = Button(janela, textvariable=msg, font=fonts.fonte_conteudo, fg=colors.COR_BRANCA,
...
pM_botao = Button(janela, textvariable=msg, font=fonts.fonte_conteudo, fg=colors.COR_BRANCA,
                  bg=colors.COR_LARANJA_ESCURO,
                  relief="raised", command=lambda: funcoes_pomodoro.botao_pausa_click("pm_click"))
pM_botao.place(x=1160, y=458)

pL_botao = Button(janela, textvariable=msg, font=fonts.fonte_conteudo, fg=colors.COR_BRANCA,
                  bg=colors.COR_LARANJA_ESCURO,

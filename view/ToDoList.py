...
def criar_janela_todo_list():
    ...
    Botao_Team = "Sobre"
    label = Button(frame_top, text=Botao_Team, fg=colors.COR_BRANCA, bg=colors.COR_CINZA_ESCURO, font=('monospace', 32),command=Funcoes_main.renderizar_team(janela), relief=FLAT)

...
def criar_janela_todo_list():
    ...
    Botao_Home = "Home"
    label = Button(frame_top, text=Botao_Home, fg=colors.COR_BRANCA, bg=colors.COR_CINZA_ESCURO, font=('monospace', 32),
                   relief=FLAT, command=lambda: Funcoes_main.renderizar_home(janela)
                   )
    ...
    Botao_Team = "Sobre"
    label = Button(frame_top, text=Botao_Team, fg=colors.COR_BRANCA, bg=colors.COR_CINZA_ESCURO, font=('monospace', 32),
                   command=..., relief=FLAT)
    ...
    botao_add = Button(frame_meio, image=img_update, command=lambda: funcoes_todolist.atualizarTarefa(Entrada_idTask),
    ...
    botao_delete = Button(frame_meio, command=lambda: funcoes_todolist.deletarTarefaEspecifica(Entrada_idTask),
    ...
    botao_all_delete = Button(frame_meio, command=funcoes_todolist.deletarTodasTasks, image=img_all_delete,
                              relief=GROOVE,
